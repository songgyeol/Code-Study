...
class ThirdViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        greenBtn.leadingAnchor.constraint(equalTo: safeArea.leadingAnchor, constant: 150).isActive = true
        greenBtn.trailingAnchor.constraint(equalTo: safeArea.trailingAnchor, constant: -150).isActive = true
