...
class SecondViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        bluBtn.leadingAnchor.constraint(equalTo: safeArea.leadingAnchor, constant: 150).isActive = true
        bluBtn.trailingAnchor.constraint(equalTo: safeArea.trailingAnchor, constant: -150).isActive = true
