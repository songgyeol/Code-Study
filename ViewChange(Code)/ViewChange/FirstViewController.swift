...
class FirstViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        redBtn.leadingAnchor.constraint(equalTo: safeArea.leadingAnchor, constant: 150).isActive = true
        redBtn.trailingAnchor.constraint(equalTo: safeArea.trailingAnchor, constant: -150).isActive = true
