...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        redButton.addTarget(self, action: #selector(redBtnTapped), for: .touchUpInside)
        ...
        redButton.leadingAnchor.constraint(equalTo: safeArea.leadingAnchor, constant: 150).isActive = true
        blueButton.leadingAnchor.constraint(equalTo: safeArea.leadingAnchor, constant: 150).isActive = true
        greenButton.leadingAnchor.constraint(equalTo: safeArea.leadingAnchor, constant: 150).isActive = true
        
        redButton.trailingAnchor.constraint(equalTo: safeArea.trailingAnchor, constant: -150).isActive = true
        blueButton.trailingAnchor.constraint(equalTo: safeArea.trailingAnchor, constant: -150).isActive = true
        greenButton.trailingAnchor.constraint(equalTo: safeArea.trailingAnchor, constant: -150).isActive = true
    }
